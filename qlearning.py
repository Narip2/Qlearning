...
#     state_choice = qtable.iloc[state,:]
#     if np.random.uniform() > EPSILON or state_choice.all() == 0:
#         action = np.random.choice(ACTIONS)
#     else:
#         action = state_choice.argmax()
#     return action
...
# def rl():
#     qtable = q_table(N_STATE,ACTIONS)
#     for epoch in range(MAX_EPISODES):
#         step_counter = 0
#         S = 0
#         is_terminate = False
#         update_env(S, epoch, step_counter)
...
#             S = S_
#             update_env(S, epoch, step_counter+1)  # 环境更新
#             step_counter += 1
